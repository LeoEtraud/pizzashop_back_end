...
exports.monthCanceledOrdersAmountRouter = void 0;
const express_1 = require("express");
const dayjs_1 = __importDefault(require("dayjs"));
const prismaClient_1 = require("../../database/prismaClient");
const authentication_1 = require("../../middlewares/authentication");
exports.monthCanceledOrdersAmountRouter = (0, express_1.Router)();
exports.monthCanceledOrdersAmountRouter.get("/metrics/month-canceled-orders-amount", authentication_1.authentication, async (req, res, next) => {
    try {
