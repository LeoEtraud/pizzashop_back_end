...
exports.monthReceiptRouter = void 0;
const express_1 = require("express");
const dayjs_1 = __importDefault(require("dayjs"));
const prismaClient_1 = require("../../database/prismaClient");
const authentication_1 = require("../../middlewares/authentication");
exports.monthReceiptRouter = (0, express_1.Router)();
exports.monthReceiptRouter.get("/metrics/month-receipt", authentication_1.authentication, async (req, res, next) => {
    try {
        ...
        for (const r of rows) {
            ...
            if (key === currentKey)
                currentReceipt += r.totalInCents;
            else if (key === lastKey)
                lastReceipt += r.totalInCents;
        }
        const diffFromLastMonth = lastReceipt && currentReceipt
